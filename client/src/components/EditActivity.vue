            ...
            <div class="createActivityContentContainer">
                <form class="CreateActivityFormContainer">
                    ...
                    <div class="addedActivityTypeContainer">
                        <div class="addedActivityContainer" v-for="addedActivity in activity_types_selected"
                             v-bind:key="addedActivity">
                            <label class="addedTypeContainer">{{addedActivity}}</label>
                            <button class="deleteActivityTypeButton" v-on:click="removeActivityType(addedActivity)">
                                Remove
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="confirmButtonContainer">
                        <button id="editActivityButton" type="button" v-on:click="saveEditedActivity()">Save Changes
                        </button>
        ...
        created: async function () {
            ...
            await apiUser
                ...
                .then(response => {
                    ...
                    this.activity_types_selected = this.activity.activity_types.map(e => e.name)
