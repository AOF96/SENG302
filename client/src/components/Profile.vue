      ...
      <div id="profileWrap">
        <div id="profilePublicInfo">
          ...
          <div id="userQuickInfoWrap">
            <h1 id="userName">{{ user.firstname }} {{ user.lastname }} <span v-if="user.nickname" id="userNickname">({{ user.nickname }})</span></h1>
            <h2 v-if="user.fitnesslevel" id="userFitnessLevel">Fitness Level: {{ user.fitnessLevel }}</h2>
          </div>
