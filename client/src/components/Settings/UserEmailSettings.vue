...
<div id="settingsWrap">
    ...
    <transition name="fade">
        <div id="cover" v-if="showEditBox" @click="showEditBox = !showEditBox"></div>
    </transition>
