...
<div id="settingsWrap">
    ...
    <div class="settingsContent">
        ...
        <form @submit.prevent>
            ...
            <h2>Middle Name</h2>
            <input class="editProfileInput" type="text" name="lname" v-model="searchedUser.middlename" placeholder="Middle Name">
            <h2>Last Name</h2>
            <input class="editProfileInput" type="text" name="lname" v-model="searchedUser.lastname" placeholder="Last Name*" required>
            <h2>Nickname</h2>
            <input class="editProfileInput" type="text" name="nickname" v-model="searchedUser.nickname" placeholder="Nickname">
            <h2>Gender</h2>
            <select class="editProfileInput editProfileInputGender" v-model="searchedUser.gender" name="gender" placeholder="Gender" value="Gender" required>
            ...
            <h2>Fitness Level</h2>
            <select class="editProfileInput editProfileInputGender" v-model="searchedUser.fitness" name="fitnesslevel" placeholder="fitness" value="fitness" required>
            ...
            <h2>Birthday</h2>
            <input v-model="searchedUser.date_of_birth" class="editProfileInput" name="birthday" type="date" required>
            <h2>Bio</h2>
            <textarea maxlength="255" class="editProfileTextarea" name="bio" v-model="searchedUser.bio" placeholder="Write about yourself"></textarea>
