    ...
    <div class="signUpContainer">
      <div class="signUpFormContainer">
        ...
        <form @submit.prevent>
          ...
          <div class="signUpRow">
            <input id="signup-firstname" class="signUpHalfWidthInput" v-model="user.firstname" name="fname" type="text"
                   placeholder="First Name*" required/>
            <input id="signup-middlename" class="signUpHalfWidthInput" v-model="user.middlename" name="middlename"
                   type="text" placeholder="Middle Name"/>
          </div>
          <p id="signup-firstname-err" v-if="!validation.firstname" class="errorMessage">{{ this.err_msg.firstname
            }}</p>
          <div class="signUpRow">
            <input id="signup-lastname" class="signUpInput" v-model="user.lastname" name="lname" type="text"
          ...
          <div class="signUpRow">
            <textarea id="signup-bio" maxlength="255" v-model="user.bio" class="signupTextarea" name="bio" type="text"
                      placeholder="Bio"></textarea>
          </div>
          <div class="signUpRow">
            <input id="signup-primary-email" v-model="user.primary_email" class="signUpInput" name="email" type="email"
                   placeholder="Email*" required/>
          </div>
          <p id="signup-primary-email-err" v-if="user.primary_email && !validation.email" class="errorMessage">
            {{this.err_msg.email }}
          </p>
          <div class="signUpRow">
            <h3 class="signUpText">Birthday*</h3>
            <input id="signup-dob" v-model="user.date_of_birth" class="signUpInputBirthday" name="birthday" type="date"
          ...
          <div class="signUpRow">
            ...
            <select id="signup-fitness-level" class="fitnessLevelSelect" v-model="user.fitness" name="fitnesslevel" required>
          ...
          <div class="signUpRow">
            <input id="signup-password-1" v-model="password1" class="signUpInput" name="pass1" type="password"
                   placeholder="Password*" required/>
          </div>
          <div class="signUpRow">
            <input id="signup-password-2" v-model="password2" class="signUpInput" name="pass2" type="password"
          ...
          <ul id="signup-password-err" class="errorMessage">
            ...
            <li v-if="passwordInputIsFilled && !validation.password.lowercase">{{ this.err_msg.password.lowercase }}
            </li>
            <li v-if="passwordInputIsFilled && !validation.password.uppercase">{{ this.err_msg.password.uppercase }}
            </li>
          </ul>
          <div class="signUpRow">
