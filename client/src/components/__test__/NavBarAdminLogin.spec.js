...
describe('NavBar after the login is successful', () => {
    ...
    // these commented out tests are failing due to some error related to vuetify components
    // it('Clicking on the Search button the user gets redirected to the Search page', async () => {
    //     const wrapper = mount(NavBar, {store, localVue, router})
    ...
    // })
    //
    // it('Clicking on the admin dashboard button the user gets redirected to Admin dashboard', async () => {
    //     const wrapper = mount(NavBar, {store, localVue, router})
    ...
    // })
    //
    // it('Clicking on the Profile button the user gets redirected to their profile page', async () => {
    //     const wrapper = mount(NavBar, {store, localVue, router})
