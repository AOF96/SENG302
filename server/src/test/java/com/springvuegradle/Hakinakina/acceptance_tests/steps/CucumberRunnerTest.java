...
@CucumberOptions(
        ...
        glue = {"src/test/java/com/springvuegradle/Hakinakina/acceptance_tests/steps"}, // Where to look for your tests' steps
        features = {"classpath:src/test/resources/com.springvuegradle.Hakinakina.features"}, // Where to look for your features
